...
import { type IUserOptions, TCoords } from "animated-scroll-to";

vi.mock("animated-scroll-to", () => {
  return {
    __esModule: true,
    default: (coords: TCoords, options: IUserOptions): Promise<boolean> => {
      // @ts-ignore
    ...
    <>
      <div data-testid="tabs">
        <FluidTabs tabsRef={tabsRef} component="div">
          <button style={{ width: 100 }} onClick={() => setValue(0)}>
            Tab 1 {value === 0 ? "selected" : ""}
          </button>
          <button style={{ width: 50 }} onClick={() => setValue(1)}>
            Tab 2 {value === 1 ? "selected" : ""}
          </button>
          <button style={{ width: 100 }} onClick={() => setValue(2)}>
            Tab 3 {value === 2 ? "selected" : ""}
          </button>
        </FluidTabs>
        <div
      ...
      <div data-testid="panels" ref={setTabPanelsRef} style={{ width: 300 }}>
